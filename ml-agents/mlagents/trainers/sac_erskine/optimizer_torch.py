...
class SACErskineSettings(OffPolicyHyperparamSettings):
    batch_size: int = 128
...
class TorchSACErskineOptimizer(TorchOptimizer):
    ...
    def __init__(self, policy: TorchPolicy, trainer_settings: TrainerSettings):
        ...
        hyperparameters: SACErskineSettings = cast(
            SACErskineSettings, trainer_settings.hyperparameters
        )
        ...
        self.q_network = TorchSACErskineOptimizer.PolicyValueNetwork(
            self.stream_names,
        ...
        self._log_ent_coef = TorchSACErskineOptimizer.LogEntCoef(
        ...
        self.target_entropy = TorchSACErskineOptimizer.TargetEntropy(
